...
variations = {
    ...
    createVariations: function() {
        ...
        if(json.Name == "Barra Telescópia"){
            //adicionamos a div inicial para receber as primeiras referencias
        container.append("<div id='barratelescopia' class='references' data-reference='" + json.IdReference +"' data-active='true'><span class='title'>"+ json.Name +"</span><div class='variations'></div></div>")
        }
        else{
    ...
    generateHTML: function(imageURL, Color, IdVariation, IdVariationFather,  Name, reference) {
        ...
        if(imageURL) {
            ...
            btn = '\n\
                <div class="ui variacao check" id="btn'+ IdVariation +'" data-variation="'+ IdVariation +'" '+IdVariationFather+'>\n\
